...
def gerar_cards_mpl(kpis, contrato):
    ...
    draw_card_mobile(2+w+g, y2, w, 18, "Fora do Prazo (8-24h)", kpis['sla_yellow'], C_YELLOW)
        ...
        if not opcoes_validas:
            ...
            with tab_op:
                ...
                if df.empty:
                    ...
                    f_sla = col_f2.multiselect("Filtrar SLA", ["Crítico", "Fora do Prazo", "No Prazo"], placeholder="Selecione...")
